...
const Team = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="py-16 bg-deep-navy relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute top-10 right-10 w-20 h-20 bg-lime-green/10 rounded-full blur-xl"></div>
        <div className="absolute bottom-10 left-10 w-16 h-16 bg-baby-blue/10 rounded-full blur-lg"></div>
      ...
      <section className="py-16 bg-deep-navy relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute top-20 left-20 w-24 h-24 bg-baby-blue/10 rounded-full blur-xl"></div>
        <div className="absolute bottom-20 right-20 w-18 h-18 bg-lime-green/10 rounded-full blur-lg"></div>
        <div className="section-padding container-max">
