...
const TeamCard = ({ name, credentials, bio }: TeamCardProps) => {
  return (
    <div className="bg-deep-navy rounded-lg shadow-sm border border-gray-100 overflow-hidden">
      {/* Placeholder headshot */}
      <div className="h-64 bg-steel-blue flex items-center justify-center">
