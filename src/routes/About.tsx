  ...
  return (
    <>
      ...
      <section className="py-16 bg-deep-navy relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute top-16 right-16 w-20 h-20 bg-lime-green/10 rounded-full blur-xl"></div>
        <div className="absolute bottom-16 left-16 w-16 h-16 bg-baby-blue/10 rounded-full blur-lg"></div>
        <div className="absolute top-1/2 left-1/4 w-12 h-12 bg-lime-green/5 rounded-full blur-md"></div>
        <div className="section-padding container-max">
