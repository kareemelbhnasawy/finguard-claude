            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="text-gray-300">
                  ...
                  <span className="text-gray-300">{company.contact.website}</span>
                </p>
              </div>
            </div>
              ...
              <ul className="space-y-2">
                {quickLinks.map((link) => (
                  <li key={link.name}>
                    <Link
                      to={link.href}
                      className="text-gray-300 hover:text-white transition-colors text-sm focus-visible:focus-visible"
                    >
                      {link.name}
                    </Link>
                  </li>
